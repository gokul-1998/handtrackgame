...
######################################################################################
#Images
ImgBalloon = pygame.image.load('/Users/gokulakrishnan/Desktop/extra study/hand track/Balloon-Pop-Game-Using-Python-OpenCV/Ballon Pop (Pygame)/Images_Project/BalloonRed.png').convert_alpha()

ImgBalloon_2 = pygame.image.load('/Users/gokulakrishnan/Desktop/extra study/hand track/Balloon-Pop-Game-Using-Python-OpenCV/Ballon Pop (Pygame)/Images_Project/BalloonBlue.png').convert_alpha()
ImgBalloon_2 = pygame.transform.scale(ImgBalloon_2,(115,200))

ImgBalloon_3 = pygame.image.load('/Users/gokulakrishnan/Desktop/extra study/hand track/Balloon-Pop-Game-Using-Python-OpenCV/Ballon Pop (Pygame)/Images_Project/BalloonMultiColor.png').convert_alpha()
ImgBalloon_3 = pygame.transform.scale(ImgBalloon_3,(200,250))

ImgPop = pygame.image.load('/Users/gokulakrishnan/Desktop/extra study/hand track/Balloon-Pop-Game-Using-Python-OpenCV/Ballon Pop (Pygame)/Images_Project/Pop.png').convert_alpha()
...
while Start:
    ...
    if (Time < 0):          #If Time Over then
        ...
        font = pygame.font.Font('/Users/gokulakrishnan/Desktop/extra study/hand track/Balloon-Pop-Game-Using-Python-OpenCV/Ballon Pop (Pygame)/Images_Project/Marcellus-Regular.ttf',50)
